...
public class SetNewPin_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String PhoneNumber2=pref.getString("phoneNum","");
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(epin1.length() == 4 && epin1.equals(epin2)==true ) {
                    ...
                    user.put("Pin",epin1);
                    user.put("Phone_Number",PhoneNumber2);
        ...
        ((EditText)findViewById(R.id.newpin1)).addTextChangedListener(new TextWatcher() {
        ...
        ((EditText)findViewById(R.id.newpin2)).addTextChangedListener(new TextWatcher() {
        ...
        findViewById(R.id.t9_key_0).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_1).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_2).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_3).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_4).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_5).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_6).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_7).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_8).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_9).setOnClickListener(SetNewPin_Activity.this);
        findViewById(R.id.t9_key_backspace).setOnClickListener(SetNewPin_Activity.this);
